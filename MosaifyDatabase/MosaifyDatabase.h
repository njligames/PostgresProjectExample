...
namespace NJLIC {
    ...
    public:
        ...
        bool readUser(const std::string& email, int &id, std::string &error_message);
        bool readUser(int user_id, std::string& email, std::string& first_name, std::string& last_name, std::string &error_message);
